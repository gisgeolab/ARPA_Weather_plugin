...
A notebook used for testing the plugin functionalities is provided in the [ARPA_Wheater_notebook](https://github.com/gisgeolab/ARPA_Weather_plugin/tree/ARPA_Weather_Notebook) branch.
